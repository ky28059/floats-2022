...
gpio = pigpio.pi()
gpio.set_mode(TALON_PIN, pigpio.OUTPUT)
...
def convert_duty_cycle(p: float) -> float:
    ...
    return ((constrained * (MAX_MS - MID_MS)) + MID_MS) / CYCLE_TIME * PWM_RANGE
...
if __name__ == '__main__':
    ...
    gpio.hardware_PWM(TALON_PIN, PULSE_FREQUENCY, MID_MS / CYCLE_TIME * 1000000)
